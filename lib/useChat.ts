...
import { nanoid, createChunkDecoder, COMPLEX_HEADER } from './util';
...
const getStreamedResponse = async (
  ...
  const constructedMessagesPayload = sendExtraMessageFields
    ...
    : chatRequest.messages.map(({ role, content, name, function_call } : any) => ({
        role,
        content,
        ...(name !== undefined && { name }),
