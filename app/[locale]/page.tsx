    ...
    <main className="flex h-screen flex-col items-center justify-between bg-gray-500">
      ...
      <header className='absolute z-[100] top-0 flex items-center justify-between w-full px-[16px] mt-[20px] lg:px-[40px] lg:mt-[40px] sm:z-[300]'>
        ...
        <div className=' flex items-center'>
          {(mediaSize?.width || 0) > 640 &&
            <div className=' inline-flex items-end justify-center h-[36px] w-[108px] lg:h-[48px] lg:w-[136px] rounded-[10px] border-black border-2 bg-white shadow-[2px_2px_0px_rgba(0,0,0,1)] sm:shadow-[4px_4px_0px_rgba(0,0,0,1)] ml-[10px] sm:ml-4 hover:shadow-none cursor-pointer ' onClick={() => setShowChatModal(true)}>
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <div className=' inline-flex items-center justify-center h-[36px] w-[72px] lg:h-[48px] lg:w-[96px] rounded-[10px] border-black border-2 bg-white shadow-[2px_2px_0px_rgba(0,0,0,1)] sm:shadow-[4px_4px_0px_rgba(0,0,0,1)] ml-[10px] sm:ml-4 hover:shadow-none'>
            ...
            <DropdownMenuContent className=' mt-2 w-[160px] h-[110px] rounded-[12px] py-[14px]'>
              ...
              <DropdownMenuItem onClick={() => handleLocaleChange('zh')} className=' mt-2'>
                <div className=' h-[25px] inline-flex items-center justify-between px-3'>
                  ...
                  <span className=' text-[18px] leading-[18px] font-medium'>简体中文</span>
                </div>
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
          ...
          <a href='https://twitter.com/therealmoonbox' target="_blank" className=' ml-[10px] sm:ml-4'>
            <div className=' inline-flex items-center justify-center h-[36px] w-[36px] lg:h-[48px] lg:w-[48px] rounded-[10px] border-black border-2 bg-white shadow-[2px_2px_0px_rgba(0,0,0,1)] sm:shadow-[4px_4px_0px_rgba(0,0,0,1)] hover:shadow-none'>
      ...
      >
          ...
          <div className='h-[88.5%] sm:h-[92%] min-h-[200px] overflow-y-scroll'>
            <BotMessageItem message={"Wow~ It’s so scary. Our  ! "} />
            <UserMessageItem message={"Any other family members from there?"} />
            <BotMessageItem message={"Wow~ It’s so scary. Our It’s so scary. Our It’s so scary. Our It’s so scary. Our It’s so scary. OurIt’s so scary. Our It’s so scary. Our   ! "} />
            <BotMessageItem message={"Wow~ It’s so scary. Our It’s so scary. Our It’s so scary. Our It’s so scary. Our It’s so scary. OurIt’s so scary. Our It’s so scary. Our   ! "} />
            <BotMessageItem message={"Wow~ It’s so scary. Our It’s so scary. Our It’s so scary. Our It’s so scary. Our It’s so scary. OurIt’s so scary. Our It’s so scary. Our   ! "} />
            <BotMessageItem message={"Wow~ It’s so scary. Our It’s so scary. Our It’s so scary. Our It’s so scary. Our It’s so scary. OurIt’s so scary. Our It’s so scary. Our   ! "} />
            <UserMessageItem message={"Any other family members from there?"} />
            <UserMessageItem message={"Any other family members from there?"} />          <UserMessageItem message={"Any other family members from there?"} />
            <BotMessageItem message={"Wow~ It’s so scary. Our It’s so scary. Our It’s so scary. Our It’s so scary. Our It’s so scary. OurIt’s so scary. Our It’s so scary. Our   ! "} />
          ...
          <div className={clsx('m-auto w-full max-w-[700px] h-[48px] sm:h-[68px] rounded-[12px]  border-[2px] border-white/10 flex p-[4px] sm:px-[10px] sm:py-[8px] bg-black/40  sm:bg-[#1D1D1DFF]')}>
            <Input onChange={() => {
              if (!activeInput && Boolean(chatInputRef.current?.value)) {
                setActiveInput(true)
              }
              if (activeInput && !Boolean(chatInputRef.current?.value)) {
            ...
            <div className={clsx(
              ...
              activeInput ? "bg-[#3B84FFFF]" : 'bg-white/20'
            )} >
