...
export default function Declaration() {
  ...
  return <div className=" relative bg-black">
    ...
    <div className=" fixed right-[24px] bottom-[10px] w-[300px] opacity-30 sm:w-0 2xl:opacity-100 2xl:right-[142px] 2xl:bottom-[100px]  2xl:w-[300px] 3xl:w-[400px] 4xl:w-[500px] h-[700px]">
      <Image src={"/declaration_ill.png"} alt="ill" fill style={{ objectFit: 'contain' }} />
    </div>
    ...
    <div className=" relative z-10 max-w-[720px] mx-auto lg:ml-[298px] 2xl:ml-[398px] px-4 sm:px-3 pt-[140px] lg:pt-[250px] pb-12 sm:pb-[100px] lg:pb-[200px] h-auto ">
      <h1 id="nav1" className="title mb-[40px] lg:mb-[60px] text-[44px] lg:text-[72px] font-semibold leading-[36px] lg:leading-[60px] text-white">{t("title1")}</h1>
      <p className=" text-[18px] lg:text-[24px] font-medium leading-[30px] lg:leading-[48px] text-white">{t.rich('subtitle1', { br: () => <br /> })}
      </p>
      <h1 id="nav2" className="title mt-[60px] lg:mt-[120px] mb-[40px] lg:mb-[60px] text-[44px] lg:text-[72px] font-semibold leading-[36px] lg:leading-[60px] text-white">{t("title2")}</h1>
      <p className=" text-[18px] lg:text-[24px] font-medium leading-[30px] lg:leading-[48px] text-white">{t.rich('subtitle2', { br: () => <br /> })}</p>
      <h1 id="nav3" className="title mt-[60px] lg:mt-[120px] mb-[40px] lg:mb-[60px] text-[44px] lg:text-[72px] font-semibold leading-[36px] lg:leading-[60px] text-white">{t("title3")}</h1>
      <p className=" text-[18px] lg:text-[24px] font-medium leading-[30px] lg:leading-[48px] text-white">
        {t.rich('subtitle3', { br: () => <br /> })}
      </p>
      <h1 id="nav4" className="title mt-[60px] lg:mt-[120px] mb-[40px] lg:mb-[60px] text-[44px] lg:text-[72px] font-semibold leading-[36px] lg:leading-[60px] text-white">{t("title4")}</h1>
      <p className=" text-[18px] lg:text-[24px] font-medium leading-[30px] lg:leading-[48px] text-white">
