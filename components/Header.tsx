...
const Header: React.FC = () => {
  ...
  return (
    <>
      <header className="absolute top-0 z-[100] mt-[20px] flex w-full items-center justify-between px-[16px] sm:z-[300] lg:mt-[40px] lg:px-[40px]">
        <div className="flex items-center">
          <a href="/">
            <div className="relative h-[36px] w-[36px] sm:h-[36px] sm:w-[177px] lg:h-[48px] lg:w-[236px]">
              <Image
                src={
                  (mediaSize?.width || 0) > 640
                    ? "/moonbox_logo_white.png"
                    : "/moonbox_logo_mobile.png"
                }
                alt="logo"
                priority={true}
                fill
          ...
          {(mediaSize?.width || 0) > 1024 && (
            <div className="ml-[20px] flex items-center xl:ml-[60px]">
              <div
              ...
              >
                <span className="whitespace-nowrap text-[16px]  text-white sm:text-[18px]">
                  {t("header_mv")}
                </span>
              </div>
              <div
                className="ml-[20px] cursor-pointer xl:ml-[40px]"
                onClick={() => {
                  if (!/\/chat/.test(pathname)) {
                    track("OpenChat");
                    window.open("/chat", "_blank");
        ...
        <div className="flex items-center">
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <div className=" hover-btn-shadow ml-[10px] inline-flex h-[36px] w-[72px] items-center justify-center rounded-[10px] border-2 border-black bg-white shadow-[2px_2px_0px_rgba(0,0,0,1)] sm:ml-4 sm:h-[48px] sm:w-[96px] sm:shadow-[4px_4px_0px_rgba(0,0,0,1)]">
                <svg
                ...
                <span className=" ml-[6px] text-[16px] font-semibold leading-[16px] text-black sm:text-[18px] sm:leading-[18px]">
                  {t("header_language")}
                </span>
              </div>
            </DropdownMenuTrigger>
            <DropdownMenuContent className=" mt-2 h-[110px] w-[160px] rounded-[12px] py-[14px]">
              <DropdownMenuItem onClick={() => handleLocaleChange("en")}>
                <div className=" inline-flex h-[25px] items-center justify-between px-3">
                  <span className=" mr-[10px] text-[18px] font-semibold">
                    En
                  </span>
                  <span className=" text-[18px] font-medium leading-[18px]">
                    English
                  </span>
                </div>
              </DropdownMenuItem>
          ...
          {(mediaSize?.width || 0) < 640 && (
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <div className="hover-btn-shadow  ml-[10px] inline-flex h-[36px] w-[72px] items-center justify-center rounded-[10px] border-2 border-black bg-white shadow-[2px_2px_0px_rgba(0,0,0,1)]">
                  <svg
                    className="h-[24px] w-[24px] sm:h-[30px] sm:w-[30px]"
                    viewBox="0 0 1024 1024"
                    version="1.1"
              ...
              <DropdownMenuContent className="mt-[10px] h-[150px] w-[160px] rounded-[12px] py-[15px]">
                <DropdownMenuItem>
                  <a href="https://twitter.com/therealmoonbox" target="_blank">
                    <div className="inline-flex h-[25px] items-center justify-between px-2">
                      <svg
                ...
                <DropdownMenuItem>
                  <a href="https://discord.gg/therealmoonbox" target="_blank">
                    <div className=" inline-flex h-[25px] items-center justify-between px-2">
                      <svg
                        className="mr-[10px] h-[24px] w-[24px]"
                        viewBox="0 0 1280 1024"
