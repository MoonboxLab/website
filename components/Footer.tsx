...
const Footer = (props: FooterProps) => {
  ...
  return (
    <div className="absolute bottom-0 left-0 z-50 hidden h-[88px] w-full items-center bg-black/80 px-[20px] 4xl:h-[112px] 4xl:px-[30px]">
      <div className="flex">
        <Image
      ...
      <div
        className={clsx(
          "ml-[30px] flex 4xl:ml-[50px] 5xl:ml-[100px]",
