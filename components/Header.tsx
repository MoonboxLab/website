    ...
    <header className="relative z-[100] py-[15px] flex w-full justify-between px-[20px] sm:z-[200] 4xl:py-[20px]">
      ...
      <div className="flex items-center">
        <Link href={"/declaration"} className=" hidden lg:block" >
          <div className=' inline-flex items-center justify-center h-[36px] min-w-[84px] lg:h-[40px] lg:min-w-[80px] 3xl:h-[48px] 3xl:min-w-[96px] px-[24px] rounded-[10px] border-black border-2 bg-white shadow-[2px_2px_0px_rgba(0,0,0,1)] sm:shadow-[4px_4px_0px_rgba(0,0,0,1)] ml-[10px] sm:ml-4 hover-btn-shadow'>
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <div className=' inline-flex items-center justify-center h-[36px] w-[84px] lg:h-[40px] lg:w-[80px] 3xl:h-[48px] 3xl:w-[96px] rounded-[10px] border-black border-2 bg-white shadow-[2px_2px_0px_rgba(0,0,0,1)] sm:shadow-[4px_4px_0px_rgba(0,0,0,1)] ml-[10px] sm:ml-4 hover-btn-shadow'>
        ...
        <a href='https://twitter.com/therealmoonbox' target="_blank" className=' ml-[10px] sm:ml-4'>
          <div className=' inline-flex items-center justify-center h-[36px] w-[36px] lg:h-[40px] lg:w-[40px] 3xl:h-[48px] 3xl:w-[48px] rounded-[10px] border-black border-2 bg-white shadow-[2px_2px_0px_rgba(0,0,0,1)] sm:shadow-[4px_4px_0px_rgba(0,0,0,1)] hover-btn-shadow'>
