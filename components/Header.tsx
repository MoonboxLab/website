...
const Header: React.FC = () => {
      ...
      <header className="relative z-[100] flex w-full justify-between px-[12px] py-[8px] sm:z-[200] sm:px-[20px]">
        ...
        >
          ...
          {(mediaSize?.width || 0) > 1025 && (
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <div className="sm:hover-btn-shadow ml-[10px] inline-flex h-[36px] w-[120px] items-center justify-center rounded-[10px] border-2 border-black bg-white text-base shadow-[2px_2px_0px_rgba(0,0,0,1)] sm:ml-4 sm:shadow-[4px_4px_0px_rgba(0,0,0,1)] lg:h-[40px] lg:w-[128px] 3xl:h-[48px] 3xl:w-[128px]">
                  <span className=" ml-[6px] text-[16px]  font-semibold leading-[16px] text-black sm:text-[18px] sm:leading-[18px] 3xl:text-[21px] 3xl:leading-[21px]">
                    {t("collabMerch")}
                  </span>
                  <ChevronDown />
            ...
            <DropdownMenuContent className="mt-2 h-[110px] w-[160px] rounded-[12px] py-[14px]">
              <DropdownMenuItem onClick={() => handleLocaleChange("en")}>
                <div className=" inline-flex h-[25px] items-center justify-between px-3">
                  <span className=" mr-[10px] text-[21px] font-semibold">
                    En
                  </span>
                  <span className="text-[16px] font-medium leading-[16px]">
                    English
  ...
  Z"
      ...
      {(mediaSize?.width || 0) >= 1024 && (
        <div className="fixed right-[20px] top-1/2 z-[100] flex -translate-y-1/2 flex-col gap-4">
          <a
            href="https://twitter.com/realnobodyxyz"
            target="_blank"
            rel="noopener noreferrer"
          >
            <div className="hover-btn-shadow inline-flex h-[40px] w-[40px] items-center justify-center rounded-[10px] border-2 border-black bg-white shadow-[4px_4px_0px_rgba(0,0,0,1)] 3xl:h-[48px] 3xl:w-[48px]">
              <svg
