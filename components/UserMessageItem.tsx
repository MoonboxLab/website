...
export default function UserMessageItem(props:UserMessageItemProps) {
  ...
  return <div className="flex mb-[30px] justify-end">
    <div className=" rounded-[12px] bg-[#FFE65AFF] sm:px-[18px] sm:py-[18px] sm:text-[18px] sm:leading-[24px] sm:font-normal max-w-[700px] text-[16px] leading-[21px] font-medium p-[12px]">
      {message}
    </div>
