...
import { useBigItem, useApprove, useBidSubmit } from "@/service/hares";
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
export default function BidDetailsPage({ params }: { params: { id: string } }) {
  ...
  const [item, loading, fetchBigItem] = useBigItem(Number(params.id), "hares");
  ...
  const [bidLoading, bidSubmit] = useBidSubmit("hares");
